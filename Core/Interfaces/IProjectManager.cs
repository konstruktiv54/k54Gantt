...
public class Task
{
    ...
    [JsonProperty("Id")]
    public Guid Id { get; set; } = Guid.NewGuid();  // Обновлено: public set для десериализации
    ...
    where R : class
{
    ...
    /// </summary>
    [JsonProperty("Precedents")]
    public List<T> Precedents { get; set; }
    /// <summary>
    ...
    /// </summary>
    public List<IEnumerable<T>> CriticalPaths { get; set; }
    /// <summary>
